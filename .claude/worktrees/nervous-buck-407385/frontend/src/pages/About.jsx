        ...
        <div className="container">
          ...
          <div className="about-story-grid">
            <div className="about-story-img">
              <img src="/images/acca_strategic.png" alt="Systematics Education" />
            </div>
            <div>
              ...
              <p style={{ color: 'var(--slate)', lineHeight: 1.85, marginBottom: '14px', fontSize: '0.95rem' }}>
                Systematics Education (SMC-PVT) LTD has been Pakistan's trusted partner for ACCA students for over <strong>25 years</strong>. Founded in 1998, we set out with one mission: to make world-class professional study resources accessible to every student in Pakistan.
              </p>
              <p style={{ color: 'var(--slate)', lineHeight: 1.85, marginBottom: '14px', fontSize: '0.95rem' }}>
                As an <strong>authorised ACCA study material distributor</strong>, we deliver 100% genuine, ACCA-approved Kaplan publications nationwide — from Karachi to Gilgit.
              </p>
              <p style={{ color: 'var(--slate)', lineHeight: 1.85, marginBottom: '28px', fontSize: '0.95rem' }}>
                With over <strong>15,000 students</strong> supported, we are proud to be the most trusted name in the industry.
              </p>
