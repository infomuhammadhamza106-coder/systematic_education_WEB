          ...
          <div className="contact-grid">
            ...
            <div className="contact-info-card">
              ...
              <div style={{ borderTop: '1px solid rgba(255,255,255,0.1)', paddingTop: '24px' }}>
                <div style={{ fontSize: '0.68rem', textTransform: 'uppercase', letterSpacing: '1.5px', fontWeight: 600, color: 'rgba(255,255,255,0.35)', marginBottom: '12px' }}>
                  Bank Account
                </div>
                <div style={{ background: 'rgba(255,255,255,0.05)', border: '1px solid rgba(255,255,255,0.08)', padding: '16px', fontSize: '0.84rem', lineHeight: 1.8, borderRadius: '4px' }}>
                  <div style={{ fontWeight: 600, color: '#fff', marginBottom: '4px' }}>Systematics Education (SMC-PVT) LTD</div>
                  <div style={{ color: 'rgba(255,255,255,0.45)', fontSize: '0.75rem', marginBottom: '4px' }}>UBL — United Bank Limited</div>
                  <div style={{ fontFamily: 'monospace', color: 'rgba(255,255,255,0.8)', fontSize: '0.92rem', fontWeight: 600 }}>0110 0020 0007 1137</div>
                </div>
              </div>

              <a href="https://wa.me/923218488802" target="_blank" rel="noreferrer"
                className="btn btn-ghost-white" style={{ width: '100%', justifyContent: 'center', marginTop: '24px' }}>
            ...
            <div className="contact-form-card">
              <h3 style={{ fontFamily: 'Libre Baskerville, serif', color: 'var(--navy)', fontSize: '1.4rem', fontWeight: 700, marginBottom: '6px' }}>
                Send a Message
              </h3>
              <p style={{ color: 'var(--slate)', fontSize: '0.875rem', marginBottom: '28px' }}>
        ...
        <div className="container">
          <div style={{ textAlign: 'center', marginBottom: '36px' }}>
            <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '10px', marginBottom: '8px' }}>
              ...
              <h3 style={{ fontFamily: 'Libre Baskerville, serif', fontSize: '1.25rem', fontWeight: 700, color: '#fff' }}>Business Hours</h3>
            </div>
          ...
          <div style={{ display: 'flex', justifyContent: 'center', gap: '16px', flexWrap: 'wrap' }}>
            {[
              ...
              <div key={day} style={{
                ...
                borderRadius: '4px', padding: '20px 32px', minWidth: '180px', textAlign: 'center',
              }}>
                <div style={{ fontSize: '0.68rem', color: 'rgba(255,255,255,0.4)', fontWeight: 600, textTransform: 'uppercase', letterSpacing: '1.5px', marginBottom: '8px' }}>{day}</div>
